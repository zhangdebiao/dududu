...
class BooksManager(models.Manager):
    ...
    def add_one_book(self, type_id, name, desc, price, unit, stock, sales, detail, image, publisher):
        '''添加新图书'''
        books = self.create(type_id=type_id,
                           name=name,
                           desc=desc,
                           price=price,
                           unit=unit,
...
class Books(BaseModel):
    ...
    type_id = models.SmallIntegerField(default=1, choices=books_type_choices, verbose_name='商品种类')
    ...
    publisher = models.CharField(max_length=20, default=0, verbose_name='商品发布者')
